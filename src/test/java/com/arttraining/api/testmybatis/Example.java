...
public class Example {
    public static void main(String[] args) {
        ...
        String accessKey = "ZqROaKfnfjygnaWWfYjPUkqvrSdlAHOrJgnz0SDu";
        String secretKey = "LvxeWmiHaXfqCP3AwXO_GWkKEPC6fyA0_xL6186W";
        String streamKeyPrefix = "javasdkexample" + String.valueOf(new Date().getTime());

        String hubName = "yhy-live";
        ...
        String keyA = "javasdkexample1483692481323B";
        
        try {
			Stream streamA=hub.get(keyA);
			streamA.disable();
...
//
//        // RTMP推流地址
//        String url = cli.RTMPPublishURL("pili-publish.artforyou.cn", hubName, keyA, 3600);
//        System.out.printf("keyA=%s RTMP推流地址=%s\n", keyA, url);
//
//        //RTMP直播地址
//        url = cli.RTMPPlayURL("pili-live-rtmp.artforyou.cn", hubName, keyA);
//        System.out.printf("keyA=%s RTMP直播地址=%s\n", keyA, url);
//
//        //HLS直播地址
//        url = cli.HLSPlayURL("pili-live-hls.artforyou.cn", hubName, keyA);
//        System.out.printf("keyA=%s HLS直播地址=%s\n", keyA, url);
//
//        //HDL直播地址
//        url = cli.HDLPlayURL("pili-live-hdl.artforyou.cn", hubName, keyA);
//        System.out.printf("keyA=%s HDL直播地址=%s\n", keyA, url);
//
//        // 截图直播地址
//        url = cli.SnapshotPlayURL("pili-live-snapshot.artforyou.cn", hubName, keyA);
