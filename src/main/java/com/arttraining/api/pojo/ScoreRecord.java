...
public class ScoreRecord {
    ...
    private String consumeDescrible;
    ...
    public String getConsumeDescrible() {
        return consumeDescrible;
    }

    public void setConsumeDescrible(String consumeDescrible) {
        this.consumeDescrible = consumeDescrible == null ? null : consumeDescrible.trim();
    }
