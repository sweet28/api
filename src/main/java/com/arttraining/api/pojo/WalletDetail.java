...
public class WalletDetail {
    ...
    public Double getCurrCloudMoney() {
        return currCloudMoney;
    }

    public void setCurrCloudMoney(Double currCloudMoney) {
        this.currCloudMoney = currCloudMoney;
    }
