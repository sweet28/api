...
<body>
	...
	<div class="order">
		<ul>
			<li><a href="<%=path%>/cpa/myEarnings"><img src="<%=path%>/images/niu.png" alt=""><p style="color:red;font-weight:bold;">个人算力</p></a></li>
...
<script src="<%=path%>/js/personal/my_earning.js" type="text/javascript" charset="utf-8"></script>
</html>