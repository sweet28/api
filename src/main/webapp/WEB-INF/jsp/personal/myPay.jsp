...
<body>
	...
	<div class="order_list">
		<ul>
			<li>
				<span style="color:#E91E63;font-weight:bold;">银行卡：</span>
				<p id="yinhang"></p>
				<span id="cardId"></span>
				<p id="zhihang"></p>
				<span style='float:right;color:#fff;background: #E91E63;display: inline-block;width: 20%;height: 30px;text-align: center;line-height: 30px;'>
					<a style="color:#fff;" href="javascript:addCard();">添加</a>
				</span>
			</li>
		</ul>
		...
		<ul>
			<li>
				<span style="color:#E91E63;font-weight:bold;">支付宝：</span>
				<p id="yaoqing_url"></p>
				<span id="alipay"></span>
				<span style='float:right;color:#fff;background: #E91E63;display: inline-block;width: 20%;height: 30px;text-align: center;line-height: 30px;'>
					<a style="color:#fff;" href="javascript:addAliPay();">添加</a>
				</span>
			</li>
		</ul>
		<p style="color:gray;">******</p>
...
<script src="<%=path%>/js/personal/my_bandcard.js"></script>
</html>
