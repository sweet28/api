...
<script src="<%=path%>/js/trader/my_dd_ywc.js" type="text/javascript" charset="utf-8"></script>
...
<body>
	...
	<div class="order">
		<ul>
			...
			<li><a href="<%=path%>/cpa/traderMyDone"><img src="<%=path%>/images/o4.jpg" alt=""><p style="color:red;font-weight:bold;">交易完成</p></a></li>
